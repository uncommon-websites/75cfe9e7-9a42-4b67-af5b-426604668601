<section class="px-6 py-12 bg-[#f5f5f5]">
  <div class="max-w-[1400px] mx-auto relative rounded-sm overflow-hidden bg-[#0a2533] h-[500px] flex flex-col justify-center items-center text-center px-6">
    ...
    <img 
      src="/generated/image-confident-financial-advisor-at-desk-with-1766011021329-1.webp" 
    ...
    <div class="relative z-10 max-w-2xl">
      ...
      <h2 class="font-serif text-3xl md:text-5xl text-white mb-6 leading-tight">
        Solving the protection complexity challenge for RIAs
      </h2>
      <p class="text-gray-400 text-lg mb-10 leading-relaxed">
        Access the $650B defined outcome market with transparent FLEX options. No counterparty risk, tax-efficient structures, and institutional-grade alternatives your clients demand.
      </p>

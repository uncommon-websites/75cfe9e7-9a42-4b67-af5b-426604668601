<nav class="flex items-center justify-between px-6 py-4 bg-[#f5f5f5] text-sm font-medium border-b border-transparent">
  ...
  <div class="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
    <a href="/" class="text-gray-900 hover:text-gray-600">For advisors +</a>
    <a href="/" class="text-gray-500 hover:text-gray-900">Products</a>
  </div>

  <div class="flex items-center gap-6">
    <a href="/" class="text-gray-900 hover:text-gray-600">Contact</a>
    <a href="/" class="bg-black text-white px-5 py-2 rounded text-xs font-medium hover:bg-gray-800 transition-colors">Learn more</a>
  </div>
</nav>
